...
namespace PeakTrollMod
{
    internal sealed class CapabilityRegistry
    {
        ...
        public void Discover()
        {
            ...
            Need(FeatureCapability.DropHeldItem, ReflectionHelpers.Method(typeof(CharacterItems), "DropItemFromSlotRPC", new Type[] { typeof(byte), typeof(Vector3) }) != null, "native held-slot drop RPC missing");
