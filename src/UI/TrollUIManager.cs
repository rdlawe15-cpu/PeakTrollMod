...
namespace PeakTrollMod
{
    internal sealed class TrollUIManager
    {
        ...
        private GUIStyle Style(int size, FontStyle font, Color color, TextAnchor align, Font typeface) { GUIStyle s=new GUIStyle(GUI.skin.label);s.font=typeface;s.fontSize=size;s.fontStyle=font;s.normal.textColor=color;s.alignment=align;s.wordWrap=true;return s; }
        private GUIStyle ButtonStyle(int size, Color textColor, Color bg) { GUIStyle s=new GUIStyle(GUI.skin.button);s.font=UiFontManager.DisplayFont;s.fontSize=size;s.fontStyle=FontStyle.Bold;s.normal.textColor=textColor;s.hover.textColor=Color.white;s.active.textColor=Color.white;s.normal.background=Tint(bg);s.hover.background=Tint(new Color(Mathf.Min(1f,bg.r+.09f),Mathf.Min(1f,bg.g+.16f),Mathf.Min(1f,bg.b+.15f),bg.a));s.active.background=Tint(new Color(Mathf.Min(1f,bg.r+.16f),Mathf.Min(1f,bg.g+.22f),Mathf.Min(1f,bg.b+.20f),bg.a));s.padding=new RectOffset(10,10,6,6);return s; }
